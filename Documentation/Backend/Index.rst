...
Admin can be easily Approve / Disapprove advertisement by click on links below the **'Approve/Disapprove'** column. **'Approved'** advertisements have a value named **'Disapprove,'** and **'Disapproved'** advertisements have a value  **'Approve'** in that particular column.
